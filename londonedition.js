...
function corrections() {
	/* document.getElementById("cell1name").textContent = "Mediter-ranean Av"; */
...
square[5] = new Square("Kings' X Station", "200", "#FFFFFF", 200, 1);
...
square[14] = new Square("Northumberland Av", "£160", "#FF0080", 160, 5, 12, 60, 180, 500, 700, 900);
square[15] = new Square("Marylebone Station", "£200", "#FFFFFF", 200, 1);
square[16] = new Square("Bow St", "£180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[17] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[18] = new Square("Marlborough St", "£180", "#FFA500", 180, 6, 14, 70, 200, 550, 750, 950);
square[19] = new Square("Vine St", "£200", "#FFA500", 200, 6, 16, 80, 220, 600, 800, 1000);
...
square[23] = new Square("Fleet St", "£220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("Trafalgar Sq", "£240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("Fenchurch St Stn", "£200", "#FFFFFF", 200, 1);
square[26] = new Square("Leicester Sq", "£260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Coventry St", "£260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
...
square[31] = new Square("Regent St", "£300", "#008000", 300, 9, 26, 130, 390, 900, 110, 1275);
square[32] = new Square("Oxford St", "£300", "#008000", 300, 9, 26, 130, 390, 900, 110, 1275);
square[33] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("Bond St", "£320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Liverpool St Station", "£200", "#FFFFFF", 200, 1);
...
chanceCards[11] = new Card("ADVANCE to Trafalgar Sq. If you pass \"GO\" collect £200.", function() { advance(24);});
